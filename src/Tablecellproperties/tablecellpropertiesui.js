...
} from '@ckeditor/ckeditor5-table/src/utils/ui/table-properties';
import { debounce } from 'lodash-es';
import { getTableWidgetAncestor } from '@ckeditor/ckeditor5-table/src/utils/ui/widget';
import { getBalloonCellPositionData, repositionContextualBalloon } from '@ckeditor/ckeditor5-table/src/utils/ui/contextualballoon';
import tableCellProperties from '@ckeditor/ckeditor5-table/theme/icons/table-cell-properties.svg';
import { getNormalizedDefaultProperties } from '@ckeditor/ckeditor5-table/src/utils/table-properties';
...
export default class TableCellPropertiesUI extends Plugin {
	...
	_createPropertiesView() {
		...
		const view = new TableCellPropertiesView( editor.locale, {
			...
			disableDimensions: config.disableDimensions,
			disableAlignment: config.disableAlignment
		} );
		const t = editor.t;
